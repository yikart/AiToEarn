...
import { YoutubePubCore } from "@/app/plat/platChildren/youtube/YoutubePubCore";

export class YoutubePlat extends PlatBase {
  ...
  public async publishVideo(
    ...
    const kwaiPubCore = new YoutubePubCore(this, videoPubParams, onProgress);
