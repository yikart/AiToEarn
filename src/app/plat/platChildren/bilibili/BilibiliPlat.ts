...
import { BilibiliPubCore } from "@/app/plat/platChildren/bilibili/BilibiliPubCore";

export class BilibiliPlat extends PlatBase {
  ...
  public async publishVideo(
    ...
    const kwaiPubCore = new BilibiliPubCore(this, videoPubParams, onProgress);
