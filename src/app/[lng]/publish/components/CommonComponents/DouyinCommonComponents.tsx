...
import {
  ...
  DouyinHotSentence,
  DouyinQueryTags,
} from "@/app/plat/platChildren/douyin/douyin.type";
import {
  Button,
  Checkbox,
  Empty,
...
export const CommonActivitySelect = ({
  ...
  const init = () => {
    // TODO icpGetDouyinActivity and icpGetActivityTags
