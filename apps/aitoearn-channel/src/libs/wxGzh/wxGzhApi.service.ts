...
export class WxGzhApiService {
  ...
  async uploadTempMedia(
    ...
    try {
      ...
      this.logger.log('Error during component_access_token:', error)
      return null
    }
  }
  ...
  async addMaterial(
    ...
    try {
      ...
      this.logger.log('wx Error during addMaterial:', error)
      return null
    }
  }
  ...
  async listComment(
    ...
    try {
      ...
      this.logger.log('Error during getusersummary:', error)
      return {
        errcode: 1,
        errmsg: '请求失败',
      }
  ...
  async deleteArticle(
    ...
    try {
      ...
      this.logger.log('Error during deleteArticle:', error)
      return {
        errcode: 1,
        errmsg: '请求失败',
      }
