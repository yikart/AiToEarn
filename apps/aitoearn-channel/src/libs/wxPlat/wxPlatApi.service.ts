...
export class WxPlatApiService {
  ...
  async getPreAuthCode(componentAccessToken: string) {
    try {
      ...
      this.logger.error('------ Error wxPlat getPreAuthCode: ------', error)
      return null
    }
  }
  ...
  async getQueryAuth(componentAccessToken: string, authorizationCode: string) {
    try {
      ...
      this.logger.error('------ Error wxPlat getQueryAuth: ------', error)
      return null
    }
  }
  ...
  async setUserAppAccessTokenInfo(
    ...
    try {
      ...
      this.logger.log('Error setUserAppAccessTokenInfo :', error)
      return null
    }
  }
  ...
  async getAuthorizerInfo(
    ...
    this.logger.debug('getAuthorizerInfo---args', {
    ...
    try {
      ...
      this.logger.error('Error getAuthorizerInfo :', error)
      return null
    }
  }
}
