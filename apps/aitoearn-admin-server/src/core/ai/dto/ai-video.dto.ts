...
import { z } from 'zod'
import { AspectRatio, KlingMode, VolcengineContentType, VolcengineImageRole } from '../common'
...
export class VideoGenerationRequestDto extends createZodDto(
...
export class UserListVideoTasksQueryDto extends createZodDto(
  listUserVideoTasksQuerySchema,
) {}
...
const klingText2VideoRequestSchema = z.object({
  ...
  mode: z.enum(KlingMode).optional().describe('生成视频的模式'),
  duration: z.enum(['5', '10']).optional().describe('生成视频时长'),
  external_task_id: z.string().optional().describe('自定义任务ID'),
})

export class KlingText2VideoRequestDto extends createZodDto(
  klingText2VideoRequestSchema,
) {}
...
export class VolcengineGenerationRequestDto extends createZodDto(
  volcengineGenerationRequestSchema,
) {}
...
export class KlingImage2VideoRequestDto extends createZodDto(
  klingImage2VideoRequestSchema,
) {}
...
export class KlingMultiImage2VideoRequestDto extends createZodDto(
  klingMultiImage2VideoRequestSchema,
) {}
...
export class VolcengineTaskQueryDto extends createZodDto(
  volcengineTaskQuerySchema,
) {}
...
export class DashscopeText2VideoRequestDto extends createZodDto(
  dashscopeText2VideoRequestSchema,
) {}
...
export class DashscopeImage2VideoRequestDto extends createZodDto(
  dashscopeImage2VideoRequestSchema,
) {}
...
export class DashscopeKeyFrame2VideoRequestDto extends createZodDto(
  dashscopeKeyFrame2VideoRequestSchema,
) {}
...
export class DashscopeTaskQueryDto extends createZodDto(
  dashscopeTaskQuerySchema,
) {}
