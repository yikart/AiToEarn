    ...
    <div className={styles.albumDetailContainer}>
      <div className={styles.header}>
        <div className={styles.titleSection}>
          ...
          <span className={styles.typeTag}>{albumInfo.type === 'video' ? '视频' : '图片'}</span>
        </div>
        <Upload
            ...
            <Card
              ...
              cover={(
                <div className={styles.coverWrapper}>
                  <Image alt={material.name} src={material.url} width={300} height={300} className="w-full h-auto object-cover" unoptimized />
                  {material.type === 'video' && (
