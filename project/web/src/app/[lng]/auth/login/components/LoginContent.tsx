  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-muted">
      ...
      <div className="absolute left-6 top-6 z-20">
        <Link href="/" className="flex items-center gap-2 text-foreground no-underline hover:opacity-80 transition-opacity">
          ...
          {step === 'register' && (
            ...
            >
              ...
              <button
                ...
                className="mb-6 flex cursor-pointer items-center gap-1.5 border-none bg-transparent text-muted-foreground hover:text-foreground transition-colors"
              >
              ...
              <form onSubmit={registerForm.handleSubmit(handleRegisterSubmit)} className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    className="h-12 rounded-xl border-input bg-background px-4 text-center text-xl tracking-[0.5em] placeholder:text-muted-foreground/70 placeholder:tracking-normal focus:border-ring focus:ring-0"
                  />
