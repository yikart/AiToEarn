...
import { DollarOutlined, HistoryOutlined, WalletOutlined, CommentOutlined, LikeOutlined, EyeOutlined, PlayCircleOutlined, RobotOutlined } from "@ant-design/icons";
import { useParams, useRouter } from "next/navigation";
import { useUserStore } from "@/store/user";
import { apiGetEngagementnew, apiGetEngagementPosts, apiGetEngagementComments, apiReplyEngagementComment, apiGetPostComments, apiPublishPostComment, apiPublishCommentReply, apiGetCommentReplies } from "@/api/engagement";
import { getChatModels, createAiReplyTask } from "@/api/ai";
...
export default function InteractivePage() {
  ...
  const submitAiReply = async () => {
    if (!aiReplyTarget || !aiPrompt.trim() || !aiModel || !accountActive?.id || !platform || aiLoading) return;
    setAiLoading(true);
    try {
