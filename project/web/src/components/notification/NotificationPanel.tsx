              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                ...
                {selectedNotification.readAt && (
                  <span style={{ color: '#52c41a' }}>
                    {t('readTime')}
                    :
                    {formatTime(selectedNotification.readAt)}
                  </span>
                )}
              </div>
            </div>
                          ...
                          <div className={styles.taskContent}>
                            ...
                            {selectedTask.accountId && (() => {
                              ...
                              return publishAccount
                                ? (
                                    <p>
                                      <strong>
                                        {t('taskInfo.publisherAccount' as any)}
                                        ：
                                      </strong>
                            ...
                            {selectedTask.accountTypes && selectedTask.accountTypes.length > 0 && (
                              <p style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: 0, marginBottom: '6px' }}>
                                <strong>
                                  {t('taskInfo.platformTypes' as any)}
                                  ：
                                </strong>
      ...
      >
        <Steps
          ...
          items={taskProgress.steps.map((step, index) => ({
            ...
            description: index === 0
              ? t('acceptingTask' as any)
              : index === 1
                ? t('publishingTask' as any)
                : index === 2
                  ? t('submittingTask' as any)
