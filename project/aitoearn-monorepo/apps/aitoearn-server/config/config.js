...
module.exports = {
  ...
  ucloud: {
    ...
    imageId: UCLOUD_IMAGE_ID,
    bundleId: 'ulh.c2m4s60b30t800cbECPro',
  ...
  multilogin: {
    ...
    timeout: 30000,
    folderId: 'aab5e49e-0ec2-4254-b33f-44868dd373a2',
    agent: {
      gitUrl: 'https://github.com/yikart/browser-automation-worker.git',
      gitBranch: 'main',
