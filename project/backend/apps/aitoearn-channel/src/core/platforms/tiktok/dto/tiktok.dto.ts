...
export class VideoFileUploadSourceDto extends createZodDto(
  VideoFileUploadSourceSchema,
) {}
...
export class VideoPullUrlSourceDto extends createZodDto(
  VideoPullUrlSourceSchema,
) {}
