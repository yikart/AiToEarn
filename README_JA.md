...
<p align="center">
  <a href="https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=AiToEarn">
    <img src="presentation/atlas-cloud-logo.png" alt="Atlas Cloud" width="200">
  </a>
</p>

> 🎁 **[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=AiToEarn)** は AiToEarn のコンテンツ生成を全モーダル推論で支えます。**OpenAI 互換**の単一 API で LLM（DeepSeek、Qwen、GLM、Kimi、MiniMax…）と画像/動画生成（Seedance、Kling、Wan…）の両方を呼び出せ、ベンダーごとの個別連携は不要です。AiToEarn のチャット経路はもともと OpenAI 互換のため、`OPENAI_BASE_URL` を `https://api.atlascloud.ai/v1` に向けるだけで直接利用できます。組み込みの `atlascloud` provider（[project/aitoearn-backend/apps/aitoearn-ai/src/core/ai/libs/atlascloud](project/aitoearn-backend/apps/aitoearn-ai/src/core/ai/libs/atlascloud)）も利用できます。
>
> [coding plan](https://www.atlascloud.ai/console/coding-plan) · [モデル一覧](https://www.atlascloud.ai/models)
>
> ```env
> ATLASCLOUD_API_KEY=<atlascloud-api-key>
> ATLASCLOUD_BASE_URL=https://api.atlascloud.ai/v1
> # デフォルトのチャットモデル。deepseek-v4-pro は推論モデルのため max_tokens を十分に（>= 512）
> # ATLASCLOUD_MODEL=deepseek-ai/deepseek-v4-pro
> ```
>
> <details>
> <summary>Atlas Cloud のチャットモデル全 59 種</summary>
>
